...
## Define 2 by 2 window
png(filename = "plot4.png", width = 480, height = 480, units = "px")

par(mfrow=c(2,2))

## Plot Global Active Power per Time
plot(days2$Time,days2$Global_active_power, type="l", xlab = "", ylab = "Global Active Power")

## Plot Voltage per Time
plot(days2$Time,days2$Voltage, type="l", xlab = "datetime", ylab = "Voltage")

## Plot all Energy sub metering
...
## Plot Global Reactive Power per Time
plot(days2$Time,days2$Global_reactive_power, type="l", xlab = "datetime", ylab = "Global_reactive_power")
